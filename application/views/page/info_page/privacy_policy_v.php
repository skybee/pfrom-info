<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <h2 class="title-semibold-dark size-xl">
        Who we are
    </h2>
    <p class="size-lg mb-40">
        Our website address is: http://pressfrom.info/
    </p>
    ...
    <p class="size-lg mb-40">
        ...
        Your personal data will not only be stored in the website’s database but also in ActiveCampaign, the application we use to send our newsletters and campaign.
    </p>
